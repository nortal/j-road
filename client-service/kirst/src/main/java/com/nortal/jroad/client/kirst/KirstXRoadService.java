...
public interface KirstXRoadService {
     ...
     */
    KindlustusedResponse findKindlustusV1(XTParingKindlustusedCallback callback) throws XRoadServiceConsumptionException;

    Kindlustused2Response findKindlustus2(Kindlustused2 paring) throws XRoadServiceConsumptionException;
