...
public interface DigiluguXRoadService {
     ...
     */
    RCMRIN000030UV01Document getHl7Document(RCMRIN000029UV01Document input, CustomCallback callback) throws
            XTeeServiceConsumptionException;

    /**
     * <code>digilugu.hl7</code> service TSK query.
     */
    RCMRIN000032UV01Document getHl7TSK(RCMRIN000031UV01Document input, CustomCallback callback) throws
            XTeeServiceConsumptionException;
