...
import com.nortal.jroad.client.lrv6.types.eu.x_road.liiklusregister.AdrMtaRequest;
import com.nortal.jroad.client.lrv6.types.eu.x_road.liiklusregister.AdrMtaResponse;
...
public class Lrv6XTeeServiceImpl implements Lrv6XTeeService {
  ...
  public AdrMtaResponse findAdrSoiduk(Calendar calendar) throws XRoadServiceConsumptionException {
    AdrMtaRequest adrMtaRequest = AdrMtaRequest.Factory.newInstance();
    if (calendar != null) {
      adrMtaRequest.setKuupaev(calendar);
    }
    return liiklusregisterXTeeDatabase.adrMtaV1(adrMtaRequest);
  }
