 ...
 */
public class TechnotesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument
{
    ...
    private static final javax.xml.namespace.QName TECHNOTES$0 = 
        new javax.xml.namespace.QName("http://x-tee.riik.ee/xsd/xtee.xsd", "technotes");
    
    
    /**
     * Gets the "technotes" element
     */
    public ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes getTechnotes()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes target = null;
            target = (ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes)get_store().find_element_user(TECHNOTES$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTechnotes(ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes technotes)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes)get_store().add_element_user(TECHNOTES$0);
            }
     ...
     */
    public ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes addNewTechnotes()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public static class TechnotesImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements ee.webmedia.xtee.client.rmviki.types.ee.riik.x_tee.xsd.xtee.TechnotesDocument.Technotes
    {
        private static final long serialVersionUID = 1L;
