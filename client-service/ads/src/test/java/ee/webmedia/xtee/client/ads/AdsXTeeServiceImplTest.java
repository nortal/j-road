...
import ee.webmedia.xtee.client.ads.types.ee.maaamet.ADSnormalParingType.NormalParam.Aadressid;
import ee.webmedia.xtee.client.ads.types.ee.maaamet.ADSnormalParingType.NormalParam.Aadressid.Aadress;
import ee.webmedia.xtee.client.ads.types.ee.maaamet.ADSnormalParingType.NormalParam.Aadressid.Aadress.AdsTase1;
...
public class AdsXTeeServiceImplTest extends BaseXTeeServiceImplTest {
  ...
  public void findObjmuudatusedV2() throws XTeeServiceConsumptionException {
    AdsXTeeService.ObjMuudatusedParamCallback cb = new AdsXTeeService.ObjMuudatusedParamCallback() {
      ...
      @Override
      public void populate(ee.webmedia.xtee.client.ads.types.ee.maaamet.ADSobjmuudatusedv2ParingType.ObjMuudatusedParam objMuudatusedParam) {
        objMuudatusedParam.setMaxarv(BigInteger.valueOf(5));
      }
    };
