...
public class KmaisXTeeServiceImplTest extends BaseXRoadServiceImplTest {
  ...
  public void isikutToendavate6V1() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(isikutToendavate6V1.getDetailandmed().getIsikukood(), TEST_IK);
  }
  ...
  public void eestiKodaniku19V1() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(eestiKodaniku19V1.getDetailandmed().getIsikukood(), TEST_IK);
  }
  ...
  public void valismaalasePassiandmete12V1() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(valismaalasePassiandmete12V1.getDetailandmed().getIsikukood(), "50507295724");
  }
  ...
  public void ebaseaduslikult2() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(ebaseaduslikult2.getDetailandmed().getEnimi().toUpperCase(), "ARDE");
  }
  ...
  public void sissesoiduKeelduOmavate2() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(sissesoiduKeelduOmavate2.getDetailandmed().getEnimi().toUpperCase(), "ABEL");
  }
  ...
  public void eestiKodaniku17() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(eestiKodanikuPassPvaVastus.getDetailandmed().getPassNr().toUpperCase(), "K1166492");
  }
  ...
  public void isikutunnistuseAndmete10() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(idPvaVastus.getDetailandmed().getDokNr().toUpperCase(), "A0027818");
  }
  ...
  public void valismaalasePassiandmete10() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(valismaalasePassPvaVastus.getDetailandmed().getPassNr().toUpperCase(), "V0115316");
  }
  ...
  public void alaliseElamisloa6() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(alalineElamislubaKleebisPvaVastus.getDetailandmed().getEesnimi().toUpperCase(), "ABEL");
  }
  ...
  public void tooloaAndmete10() throws XRoadServiceConsumptionException {
    ...
    Assertions.assertEquals(toolubaPvaVastus.getDetailandmed().getEesnimi().toUpperCase(), "ALIISE-MADILDE");
  }
}
