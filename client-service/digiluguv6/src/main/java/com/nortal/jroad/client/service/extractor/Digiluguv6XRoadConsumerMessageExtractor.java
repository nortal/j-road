...
//Implemented based on com.nortal.jroad.client.service.extractor.StandardXRoadConsumerMessageExtractor
public class Digiluguv6XRoadConsumerMessageExtractor extends CustomExtractor {

	private final XmlBeansXRoadMetadata metadata;

	public Digiluguv6XRoadConsumerMessageExtractor(XmlBeansXRoadMetadata metadata) {
