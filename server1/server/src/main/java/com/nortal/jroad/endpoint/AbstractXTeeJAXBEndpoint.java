...
public abstract class AbstractXTeeJAXBEndpoint<T> extends AbstractXTeeBaseEndpoint {
  ...
  private Class<T> getParingKehaClass;
  ...
  public void setParingKehaClass(final Class<T> getParingKehaClass) {
    this.getParingKehaClass = getParingKehaClass;
  }

  protected Class<T> getParingKehaClass() {
    return getParingKehaClass;
  }
