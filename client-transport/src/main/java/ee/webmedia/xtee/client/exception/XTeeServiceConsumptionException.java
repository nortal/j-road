 ...
 * @author Roman Tekhov
 */
public class XTeeServiceConsumptionException extends IOException {
  ...
  public XTeeServiceConsumptionException(SoapFaultClientException soapFaultClientException,
                                         String database,
                                         String method,
                                         String version) {
  ...
  public XTeeServiceConsumptionException(WebServiceIOException webServiceIOException,
                                         String database,
                                         String method,
                                         String version) {
  ...
  public XTeeServiceConsumptionException(NonTechnicalFaultException nonTechnicalFaultException,
                                         String database,
                                         String method,
                                         String version) {
  ...
  private XTeeServiceConsumptionException(Exception cause, String database, String method, String version) {
    if (cause == null) {
