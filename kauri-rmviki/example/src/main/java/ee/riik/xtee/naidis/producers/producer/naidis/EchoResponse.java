/**
 * EchoResponse.java This file was auto-generated from WSDL by the Apache Axis 1.4 Apr 22, 2006 (06:55:48 PDT) WSDL2Java
 * emitter.
 */
...
public class EchoResponse implements java.io.Serializable {
  ...
  public EchoResponse(java.lang.String text) {
    this.text = text;
  }

  /**
   * Gets the text value for this EchoResponse.
   * 
   * @return text
   */
  ...
  /**
   * Sets the text value for this EchoResponse.
   * 
   * @param text
   */
