 ...
 */
public abstract class XTeeDatabaseService {
  ...
  protected <I, O> XTeeMessage<O> send(XTeeMessage<I> input, String method, String version)
    ...
    return (XTeeMessage<O>) xTeeConsumer.sendRequest(input,
  ...
  protected <I, O> XTeeMessage<O> send(XTeeMessage<I> input,
    ...
    return (XTeeMessage<O>) xTeeConsumer.sendRequest(input, configuration, callback, extractor);
  }
