 ...
 */
public class LabelAttributeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements ee.webmedia.xtee.client.rmviki.types.org.w3.x1999.xlink.LabelAttribute
{
    ...
    public org.apache.xmlbeans.XmlNMTOKEN xgetLabel()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlNMTOKEN)get_store().find_attribute_user(LABEL$0);
            return target;
        }
    }
    ...
    public void xsetLabel(org.apache.xmlbeans.XmlNMTOKEN label)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlNMTOKEN)get_store().add_attribute_user(LABEL$0);
            }
            target.set(label);
        }
    }
