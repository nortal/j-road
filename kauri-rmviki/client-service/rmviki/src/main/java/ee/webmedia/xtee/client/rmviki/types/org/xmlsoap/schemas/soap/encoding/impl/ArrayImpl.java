 ...
 */
public class ArrayImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements ee.webmedia.xtee.client.rmviki.types.org.xmlsoap.schemas.soap.encoding.Array
{
    ...
    public ee.webmedia.xtee.client.rmviki.types.org.xmlsoap.schemas.soap.encoding.ArrayCoordinate xgetOffset()
    {
        synchronized (monitor())
        {
            ...
            target = (ee.webmedia.xtee.client.rmviki.types.org.xmlsoap.schemas.soap.encoding.ArrayCoordinate)get_store().find_attribute_user(OFFSET$2);
            return target;
        }
    }
    ...
    public void xsetOffset(ee.webmedia.xtee.client.rmviki.types.org.xmlsoap.schemas.soap.encoding.ArrayCoordinate offset)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (ee.webmedia.xtee.client.rmviki.types.org.xmlsoap.schemas.soap.encoding.ArrayCoordinate)get_store().add_attribute_user(OFFSET$2);
            }
            target.set(offset);
        }
    }
