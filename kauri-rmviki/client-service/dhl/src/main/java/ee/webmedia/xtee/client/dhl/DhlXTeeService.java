...
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_automatic.impl.DhlIdDocumentImpl;
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_automatic.impl.DhlSaabumisaegDocumentImpl;
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_automatic.impl.DhlSaatjaAsutuseNimiDocumentImpl;
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_automatic.impl.DhlSaatjaAsutuseNrDocumentImpl;
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_automatic.impl.DhlSaatjaEpostDocumentImpl;
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_automatic.impl.DhlSaatmisaegDocumentImpl;
import ee.webmedia.xtee.client.dhl.types.ee.riik.schemas.dhl_meta_manual.impl.KoostajaFailinimiDocumentImpl;
